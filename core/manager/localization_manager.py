...
TRANSLATIONS = {
    "en": {
        ...
        "hint.output_naming_schema": "Type any free text and use {TOKEN} values in the filename. Type { to open token suggestions from workbook columns plus {ROW} and {CERTIFICATE_TYPE}.",
    ...
    "it": {
        ...
        "hint.output_naming_schema": "Scrivi testo libero e usa valori {TOKEN} nel nome file. Digita { per aprire i suggerimenti dai campi Excel più {ROW} e {CERTIFICATE_TYPE}.",
