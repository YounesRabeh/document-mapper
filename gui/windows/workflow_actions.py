...
def retranslate_ui(window):
    ...
    window.sidebar_new_button.setText(window.localization.t("action.new_project"))
    window.sidebar_open_button.setText(window.localization.t("action.open_project"))
    window.sidebar_save_button.setText(window.localization.t("action.save_project"))
