...
MAPPING_TABLE_VIEWPORT_QSS = "background: palette(alternate-base);"
...
def build_workflow_page_qss() -> str:
    return WORKFLOW_PAGE_QSS.replace("__COMBO_ARROW_PATH__", _workflow_combo_arrow_path())
