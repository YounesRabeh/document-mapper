...
class Ui_SetupPageForm(object):
    def setupUi(self, setupPageForm):
        ...
        sizePolicy.setHeightForWidth(self.formCard.sizePolicy().hasHeightForWidth())
        self.formCard.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.templateOverrideCard.sizePolicy().hasHeightForWidth())
        self.templateOverrideCard.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.optionsCard.sizePolicy().hasHeightForWidth())
        self.optionsCard.setSizePolicy(sizePolicy)
        ...
        self.optionsCardLayout.setSpacing(10)
        self.optionsCardLayout.setObjectName(u"optionsCardLayout")
        self.optionsCardLayout.setContentsMargins(18, 12, 18, 12)
