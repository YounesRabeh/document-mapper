...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionLanguageEs = QAction(MainWindow)
        self.actionLanguageEs.setObjectName(u"actionLanguageEs")
        self.actionLanguageEs.setCheckable(True)
        self.actionLanguageFr = QAction(MainWindow)
        self.actionLanguageFr.setObjectName(u"actionLanguageFr")
        self.actionLanguageFr.setCheckable(True)
        self.actionLanguageDe = QAction(MainWindow)
        self.actionLanguageDe.setObjectName(u"actionLanguageDe")
        self.actionLanguageDe.setCheckable(True)
        self.actionLanguageRu = QAction(MainWindow)
        self.actionLanguageRu.setObjectName(u"actionLanguageRu")
        self.actionLanguageRu.setCheckable(True)
        ...
        self.menuLanguage.addAction(self.actionLanguageEs)
        self.menuLanguage.addAction(self.actionLanguageFr)
        self.menuLanguage.addAction(self.actionLanguageDe)
        self.menuLanguage.addAction(self.actionLanguageRu)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionLanguageEs.setText(QCoreApplication.translate("MainWindow", u"Espa\u00f1ol", None))
        self.actionLanguageFr.setText(QCoreApplication.translate("MainWindow", u"Fran\u00e7ais", None))
        self.actionLanguageDe.setText(QCoreApplication.translate("MainWindow", u"Deutsch", None))
        self.actionLanguageRu.setText(QCoreApplication.translate("MainWindow", u"\u0420\u0443\u0441\u0441\u043a\u0438\u0439", None))
